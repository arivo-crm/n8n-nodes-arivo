...
const dealFieldDefinitions = {
	...
	pipelineId: {
		...
		type: 'string',
		default: '',
		description: 'ID of the sales pipeline for this deal',
	} as INodeProperties,
	pipelineStepId: {
		...
		type: 'string',
		default: '',
		description: 'ID of the current pipeline step for this deal',
	} as INodeProperties,
	tags: {
		displayName: 'Tags',
		name: 'tags',
	...
	userId: {
		...
		type: 'string',
		default: '',
		description: 'The ID of the user assigned to this deal',
	} as INodeProperties,
	teamId: {
		displayName: 'Team ID',
		name: 'team_id',
		type: 'string',
		default: '',
		description: 'The ID of the team assigned to this deal',
	} as INodeProperties,
};
